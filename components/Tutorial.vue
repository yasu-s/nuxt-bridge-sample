<template>
  <div class="bg-gray-100 flex items-top justify-center min-h-screen relative sm:items-center sm:pt-0">
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.1.2/dist/tailwind.min.css" rel="stylesheet" />
    <div class="lg:px-8 max-w-4xl mx-auto sm:px-6">
      ...
      <div class="bg-white mt-8 overflow-hidden p-6 shadow sm:rounded-lg">
        <h2 class="font-semibold leading-7 text-2xl">Welcome to your Nuxt Application</h2>
        <p class="mt-3 text-gray-600">
          We recommend you take a look at the
          <a href="https://nuxtjs.org" target="_blank" class="button--doc hover:underline text-green-500"
            >Nuxt documentation</a
          >, whether you are new or have previous experience with the framework.<br />
        </p>
        <p class="border-dashed border-t mt-4 pt-4 text-gray-800">
          To get started, remove <code class="bg-gray-100 border p-1 rounded text-sm">components/Tutorial.vue</code> and
          start coding in <code class="bg-gray-100 border p-1 rounded text-sm">pages/index.vue</code>. Have fun!
        </p>
      </div>
      <div class="flex justify-center pt-4 space-x-2">
        <a href="https://github.com/nuxt/nuxt.js" target="_blank"
          ><svg
            class="button--github h-6 hover:text-gray-800 text-gray-600 w-6"
        ...
        <a href="https://twitter.com/nuxt_js" target="_blank"
          ><svg
            class="h-6 hover:text-gray-800 text-gray-600 w-6"
            xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink"
            aria-hidden="true"
            role="img"
